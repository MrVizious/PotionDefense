...
namespace PathCreation
{
    ...
    public class VertexPath
    {
        ...
        /// <summary>
        /// Says wether the given distance means the end has been reached
        /// </summary>
        /// <param name="distance"></param>
        /// <returns></returns>
        public bool HasReachedEndAtDistance(float distance)
        {
        ...
        public bool HasReachedEndAtTime(float t)
        {
            var data = CalculatePercentOnPathData(t, EndOfPathInstruction.Stop);
            if (data.percentBetweenIndices >= 1) return true;
            return false;
        }
